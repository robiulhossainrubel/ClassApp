...
public class FragmentFriday extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mylistview=(ListView) view.findViewById(R.id.friday_recy);


        ImageView add=(ImageView)view.findViewById(R.id.addbtfri);
        ImageView save=(ImageView) view.findViewById(R.id.savefri);
    ...
    private void loadData() {
        SharedPreferences sharedPreferences = getActivity().getSharedPreferences("shared preferences fri", MODE_PRIVATE);
        Gson gson = new Gson();
        String json = sharedPreferences.getString("routine fri list", null);
    ...
    private void saveData() {
        ...
        editor.putString("routine fri list", json);
        editor.apply();
    }
