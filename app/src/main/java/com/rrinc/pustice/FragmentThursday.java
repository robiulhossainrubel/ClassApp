...
public class FragmentThursday extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        ImageView add=(ImageView)view.findViewById(R.id.addbtthu);
        ImageView save=(ImageView) view.findViewById(R.id.savethu);
        loadData();
        mylistview=(ListView) view.findViewById(R.id.thursday_recy);
    ...
    private void loadData() {
        SharedPreferences sharedPreferences = getActivity().getSharedPreferences("shared preferences thu", MODE_PRIVATE);
        Gson gson = new Gson();
        String json = sharedPreferences.getString("routine thu list", null);
    ...
    private void saveData() {
        ...
        editor.putString("routine thu list", json);
        editor.apply();
    }
